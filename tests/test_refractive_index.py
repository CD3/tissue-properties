...
def test_navarro_data():
    ...
    # it is possible that there is a typo in Table 1 of Navarro. they report 1.367 for the cornea refractive index.
    # but it is the only one that is off by more than 0.0001 at 589 nm. If we swap the 6 and 7 (1.367 -> 1.376), it matches.
    # The other models they compare to also have 1.3771.
