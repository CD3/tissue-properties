...
class Lens(InterpolatedDataModel, CIEModel203):
    def __init__(self):
        with importlib.resources.path(
            str(__package__), "absorption_coefficient-lens-cie203_2012.txt"
        ) as datafile:
            super().__init__(
                "lens absorption coefficient", "1/cm", "wavelength", "um", datafile
            )
